        ...
        <Columns gapless>
          <Columns.Column className="masonry-wrapper">
            <div ref={this.wrapper}>
              <Masonry className="testimonials-grid" options={{ transitionDuration: 500 }}>
          ...
          {isContentOpen && <Columns.Column className="side-content">
              <Section>
                <div className="content">
                  ...
                  <p style={{ marginTop: '1em' }}>
                    Descubra o que motiva as pessoas a usar nossos
                    cosméticos - Vida Natural
                  </p>
                  <a href="#" className="plus-bt" onClick={this.toggleContent}>
                    <FaPlus />
                  </a>
                </div>
              </Section>
