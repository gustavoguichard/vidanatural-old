export default [{
  ...
  content: `A Vida Natural, mais do que uma marca, é a forma de vida da sua querida idealizadora. Não há limites separando a vida da Lila da Vida Natural e a Vida Natural da vida da Lila. Essa fusão, da criadora e da criação, é que torna os produtos que uso tão especiais para mim. Tudo nasce de uma verdade profunda, de um anseio por sustentabilidade, regeneração e saúde. O que é evidente e palpável na postura da Lila  e nos benefícios que sentimos ao nos nutrir através da Vida Natural. Obrigada, Vida Natural! Obrigada, Lila! Muito bom trilhar esse caminho com vocês, um grande privilégio!`,
}, {
  name: 'Thais e Bruno Padoveze',
  location: 'Goiânia',
  picture: 'thais-e-bruno.jpg',
  content: `Há 3 anos comprovando a eficácia, a pureza e a riqueza natural de toda a linha de produtos. Muitos, mas muitos amigos hoje em dia também são clientes e fãs dos cosméticos Vida Natural. Ainda bem existem produtos tão seguros e naturais ao alcance de nossas mãos aqui no Brasil. Obrigado Lila!`,
}, {
  name: 'Samira Abdalah',
  ...
  ratio: '2by3',
  content: `Todos os produtos que experimentei da Vida Natural foram muito eficientes. O que já é um grande ponto positivo. Mas talvez o mais importante para mim seja saber que eles foram feitos com carinho e, principalmente, sem o uso de nenhum produto de origem animal. É um grande diferencial. Por estes dois motivos, recomendo fortemente`,
}, {
  name: 'Dircéia',
  role: 'Nutricionista',
  location: 'Garopaba / SC',
  picture: 'dirceia.jpg',
  content: `Sou nutricionista e há alguns anos vinha procurando por um desodorante que não prejudicasse minha saúde, livre de alumínio, parabenos e outras substâncias tóxicas. Na época que comecei a procurar, em torno de 10 anos atrás, não achava nada aqui no Brasil, então sempre que viajava eu buscava por um diferente, na esperança que fosse ótimo, afinal eram marcas importadas e de ótima qualidade! Fiquei um bom tempo intercalando os desodorantes normais com os livres de alumínio pois não achava um realmente bom. Foi então que um dia estava comprando alguns produtos em uma loja de Garopaba e achei o desodorante da Vida Natural! Olhei os ingredientes, como de costume, e fiquei super empolgada com a composição! Ainda mais que eu tinha feito recentemente um curso de aromaterapia e sabia dos benefícios dos óleos essenciais na sua composição! Quando usei fiquei suuuuper feliz! Enfim achei um produto de qualidade, realmente natural e que funciona! Uso e indico para todos!! Obrigada por criar esse excelente produto! A saúde e a natureza agradecem!`,
}, {
  name: 'Aline blasius',
  role: 'Dançarina',
  location: 'Florianópolis / SC',
  ...
  ratio: '2by3',
  content: `Faz quase dois anos que uso o desodorante e o pó dental e são muito eficientes! As embalagens são práticas de carregar na bolsa. Sem veneninhos e sem crueldade! Recomendo!`,
}, {
  name: 'Zilda Gama',
  location: 'Belém / PA',
  picture: 'zilda-gama.jpg',
  content: `Em 2015 fui diagnosticada com câncer de mama o que me levou a iniciar uma busca por explicações para a causa da doença, especialmente em pessoas jovens e sem outros casos na família, eu tinha 34 anos. Nessa busca eu encontrei estudos que relacionavam o ca de mama a algumas substâncias presentes nos antitranspirantes o que me fez querer mudar meus hábitos de higiene e assim eu inicie uma nova busca, agora por desodorantes que fossem produzidos com a menor quantidade de substâncias possíveis e sem aquela infinidade de produtos químicos dos antitranspirantes disponíveis no mercado. Foi assim, que eu encontrei o desodorante da Vida Natural sendo vendido em um restaurante indiano de Porto Alegre e que atendeu todas as minhas expectativas. Em 2017, porém me mudei para Belém, mas não sabia mais viver sem o desodorante da vida natural e minha busca recomeçou, foi quando encontrei a página da Vida Natural no facebook e as gurias facilitam minha vida mandando para mim pelos correios sempre que eu os peço.`,
}, {
  ...
  content: `Incrível!  Único desodorante natural que realmente superou os químicos. .... super aprovo 5 anos q só uso vida natural!!!`,
}, {
  name: 'Mayara',
  ...
  Obrigada eu por criar esses produtos incríveis que eu tanto amo e uso desde que conheci 💞🌱🙏`,
}, {
  name: 'Andrea Freire',
  role: 'Bióloga',
  location: 'Florianópolis / SC',
  picture: 'andrea-freire.jpg',
  content: `Durante 1 mês de árduo trabalho físico, velejando sob um sol escaldante e muito calor, o desodorante funcionou muito bem. Os produtos Vida Natural serão usados pelos pesquisadores no veleiro ECO/UFSC, pois aliam eficiência a sustentabilidade ambiental.`,
}, {
  name: 'Denise Franco',
  role: 'Vendedora',
  location: 'Canoas / RS',
  picture: 'denise-franco.jpg',
  content: `Conheci os Cosméticos Vida Natural digamos em um momento muito marcante da minha vida, em Fevereiro de 2016 fui diagnosticada com carcinoma Infiltrativo de Mama, com uma filhinha de apenas três anos, não me permiti desesperar, resolvi iniciar imediatamente uma alimentação natural e acompanhamento com um especialista da Área, e a primeira recomendação foi:  Não utilizar nenhum desodorante comum. Foi aí que começou outro problema, sempre tive problemas com transpiração excessiva e receitas caseiras ou desodorantes Naturais com precinhos bem altos, simplesmente não funcionavam para mim. Foi então que encontrei os desodorantes Cosméticos Vida Natural em uma casa de produtos Naturais, e já no primeiro dia fiquei aliviada, pois agora havia uma luz no fim do Túnel, naquele momento poderia me concentrar somente na recuperação do meu corpo Físico, sem me preocupar com certos tipos de odores. Hoje já recuperada, tenho a consciência de quanta química está não só em mossa alimentação, mas também nos produtos para cabelo e principalmente para pele, produtos altamente prejudiciais a nossa saúde e bem estar, e que estamos expostos a todo tempo, sem podermos contar com essa indústria e governo da “Doença”. Sinto uma profunda gratidão por haver pessoas empreendedoras que de certa forma enfrentam esse mercado criminoso, e apresentam produtos feitos com carinho e respeito, cuidando verdadeiramente do próximo.`,
}, {
  name: 'Samira Kohn',
  role: 'Empreendedora',
  location: 'Florianópolis / SC',
  ...
  content: `O que me encanta nesses produtos da Via Natural é que, além de serem feitos com ingredientes naturais e de ótima qualidade, são feitos com muito carinho e amor, e isso os transforma em verdadeiras "poções" de beleza e bem estar!`,
}, {
  name: 'Aline Niehues',
  role: 'Professora de Yoga',
  ...
  ratio: '2by3',
  content: `Conhecemos a vida natural ,a mais ou menos,dois anos,e foi amor ao primeiro uso!Toda a nossa família usa os produtos,e desde então não consumimos outro.Tudo na vida natural,é feito com muito amor e carinho,isso se observa pela qualidade e aroma que os acompanha.Nós nos sentimos privilegiados por poder usar os produtos da vida natural e espero que assim seja por longos anos.Somos muito gratos por poder fazer parte deste caminho que visa o nosso bem-estar,mas em conjunto com os outros seres! Nosso agradecimento em especial e carinhoso à Dalila Ozório,criadora dos produtos!`,
}, {
  ...
  content: `Utilizo os produtos da Vida Natural há algum tempo, em especial os desodorantes e o pó dental. Considero todos de excelente qualidade. Os desodorantes são super eficazes: passo apenas uma vez ao dia, pela manhã, e eles geralmente duram o dia todo, sem necessidade de reaplicação. O pó dental também é uma ótima alternativa à pasta de dente tradicional. Além disso, o fato de serem feitos com ingredientes 100% naturais e veganos também proporcionam tranquilidade e segurança, por sabermos que não representam quaisquer riscos à nossa saúde ou de outros seres.`,
}, {
  ...
  content: `Há 5 anos já uso os produtos da marca Vida Natural. Acompanho o crescimento dos produtos desde o início da produção e tenho certeza continuará crescendo por sua qualidade e comprometimento com seus princípios de zelar pela saúde dos clientes. Fruto de um trabalho feito com muito amor, idealismo e muita preocupação com a opinião de seu consumidor, transformando as criticas em melhorias.`,
}, {
  name: 'Bruno Pasti',
