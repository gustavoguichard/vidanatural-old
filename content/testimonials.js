export default [{
  ...
  ratio: '2by3',
  content: `Há mais de dois anos que uso o desodorante em pasta em **não troco** por outro. **Super eficiente**, **100% Natural**, e rende muito, uso por pelo menos **2 meses o mesmo** tubinho.
  ...
  Além de serem uma **escolha de consumo consciente e responsável**, eles deixam minha pele cheirosa e nutrida por muito tempo, **livre de toxinas** que ao longo dos anos possam danificar minha **saúde**.`,
}, {
  ...
  Essa fusão, da criadora e da criação, é que torna os **produtos que uso tão especiais** para mim. Tudo nasce de uma **verdade profunda**, de um anseio por **sustentabilidade, regeneração e saúde**. O que é evidente e palpável na postura da Lila e nos benefícios que sentimos ao nos nutrir através da Vida Natural.
  Obrigada, Vida Natural! Obrigada, Lila! Muito bom trilhar esse caminho com vocês, um grande privilégio!`,
}, {
  ...
  Ainda bem que existem produtos tão **seguros e naturais** ao alcance de nossas mãos aqui no Brasil. Obrigado Lila!`,
}, {
  name: 'Samira Abdalah',
  ...
  Nessa busca eu encontrei estudos que relacionavam o **câncer de mama** a algumas substâncias presentes nos antitranspirantes o que me fez querer **mudar meus hábitos** de higiene e assim eu iniciei uma nova busca, agora por desodorantes que fossem produzidos com a menor quantidade de substâncias possíveis e sem aquela infinidade de produtos químicos dos antitranspirantes disponíveis no mercado.
  ...
  Em 2017, porém me mudei para Belém, mas não sabia mais viver sem o desodorante da Vida Natural e minha busca recomeçou, foi quando encontrei a página da Vida Natural no facebook e as gurias facilitam minha vida **mandando para mim pelos correios** sempre que eu os peço.`,
}, {
  ...
  Obrigada por criar esses produtos incríveis que **eu tanto amo** e uso desde que conheci 💞🌱🙏`,
}, {
  name: 'Andrea Freire',
  role: 'Bióloga',
  location: 'Florianópolis / SC',
  ...
  Foi aí que começou outro problema, sempre tive problemas com transpiração excessiva e receitas caseiras ou desodorantes naturais com precinhos bem altos, simplesmente não funcionavam para mim.
  Foi então que encontrei os Cosméticos Vida Natural em uma casa de produtos naturais, e **já no primeiro dia** fiquei aliviada, pois agora havia uma luz no fim do túnel, naquele momento poderia me concentrar somente na **recuperação do meu corpo Físico**, sem me preocupar com certos tipos de odores.
  Hoje já recuperada, tenho a **consciência** de quanta química está não só em mossa alimentação, mas também nos produtos para cabelo e principalmente para pele, produtos altamente prejudiciais a nossa saúde e bem estar, e que estamos expostos a todo tempo, sem podermos contar com essa indústria e governo da “Doença”.
  Sinto uma profunda gratidão por haver pessoas empreendedoras que de certa forma enfrentam esse mercado criminoso, e apresentam produtos feitos com **carinho e respeito**, **cuidando verdadeiramente** do próximo.`,
}, {
  name: 'Samira Kohn',
  role: 'Empreendedora',
  location: 'Florianópolis / SC',
  picture: 'samira-kohn.jpg',
  content: `Quando buscamos uma **vida mais saudável** começamos a olhar de forma **mais consciente** para as **nossas escolhas** e quanto isso nos afeta em todos os sentidos.
  Geralmente a **mudança** começa na alimentação, mas muitas vezes não percebemos o quanto a **nossa pele tem uma grande função** nessa parte.
  O **Ayurveda**, Medicina Tradicional Indiana fala: **passe na sua pele apenas o que você pode comer**. Isso caiu como uma chave na minha vida e fazia todo sentido. A **pele é o maior órgão do nosso corpo**, o que passamos na pele **vai para nossa corrente sanguínea**.
  Foi aí que comecei a ser muito mais **criteriosa** com todo cosmético que eu uso e que o Vida Natural **entrou na minha rotina**. Trouxe um **novo conceito de cuidado com o corpo**, **orgânico**, **saudável** e o melhor de tudo livre de todas aquelas substâncias nocivas usadas nos produtos de beleza.
  **Amo toda a linha** de produtos e recomendo muito!`,
  ...
  ratio: '2by3',
  content: `Os produtos Vida Natural fazem parte do **meu dia a dia**. Utilizo o **desodorante em pasta** alternado com o **roll on** e o **óleo de girassol com palmarosa e lavanda**, que é super **hidratante** e tem um **cheiro maravilhoso**.`,
}, {
  name: 'Carol Carida',
  ...
  ratio: '2by3',
  content: `Conhecemos a Vida Natural há, mais ou menos, dois anos, e foi **amor ao primeiro uso**! **Toda a nossa família usa os produtos**, e desde então não consumimos outro.
  Tudo na Vida Natural, é feito com muito **amor e carinho**, isso se observa pela **qualidade** e **aroma** que os acompanha.
  Nós nos sentimos **privilegiados** por poder usar os produtos da Vida Natural e espero que assim seja por longos anos. Somos muito gratos por **poder fazer parte deste caminho** que visa o **nosso bem-estar**, mas em conjunto com os **outros seres**!
  Nosso agradecimento em especial e carinhoso à Dalila Ozório, criadora dos produtos!`,
}, {
  ...
  Os desodorantes são **super eficazes**: passo **apenas uma vez ao dia**, pela manhã, e eles geralmente **duram o dia todo**, sem necessidade de reaplicação. O **pó dental** também é uma **ótima alternativa** à pasta de dente tradicional.
  ...
  Fruto de um trabalho feito com **muito amor**, **idealismo** e muita preocupação com a opinião de seu consumidor, transformando as críticas em melhorias.`,
}, {
  name: 'Bruno Pasti',
