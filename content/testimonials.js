export default [
  {
    ...
    ratio: '2by3',
    content: `Há mais de dois anos que uso o desodorante em pasta e **não troco** por outro. **Super eficiente**, **100% Natural**, e rende muito, uso por pelo menos **2 meses o mesmo** tubinho.
  ...
  Quando usei fiquei **suuuuper feliz**! Enfim achei um **produto de qualidade**, realmente **natural** e que funciona! Uso e indico para todos!! Obrigada por criarem esse excelente produto! A **saúde e a natureza** agradecem!`,
  },
  {
    name: 'Aline Blasius',
    role: 'Dançarina',
  ...
  Foi aí que comecei a ser muito mais **criteriosa** com todo cosmético que eu uso, e que a Vida Natural **entrou na minha rotina**. Trouxe um **novo conceito de cuidado com o corpo**, **orgânico**, **saudável** e o melhor de tudo: livre de todas aquelas substâncias nocivas usadas nos produtos de beleza.
