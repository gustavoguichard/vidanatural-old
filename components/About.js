  ...
  <Columns id="sobre" className="about-section" gapless>
    ...
    <Columns.Column>
      <Content key="content" className="black-content">
        ...
        <p>Em breve, você conhecerá muito sobre nós, inclusive o nosso processo de produção. Tudo para motivar você a dizer <strong>eu uso</strong> cosmética consciente e nos auxiliar a completar a grafia do nosso posicionamento.</p>
      </Content>
    </Columns.Column>
  </Columns>
